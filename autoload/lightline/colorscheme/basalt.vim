" =============================================================================
" Filename: autoload/lightline/colorscheme/basalt.vim
" Author: nuaNce
" Maintainer: Taurus Olson
" License: MIT License
" Last Change: 2022/08/13 13:35:42.
" =============================================================================
...
let g:lightline#colorscheme#basalt#palette = lightline#colorscheme#flatten(s:p)
